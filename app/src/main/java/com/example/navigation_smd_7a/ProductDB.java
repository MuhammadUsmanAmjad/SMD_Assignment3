...
public class ProductDB {
    ...
    public ArrayList<Product> fetchProducts(String status) {
        ...
        Toast.makeText(context, "This is product db func products: "+products, Toast.LENGTH_SHORT).show();
        return products;

    }


    public int updateAttr(int id, String title, String date, int priceInt, String s) {
        SQLiteDatabase db= dbHelper.getWritableDatabase();
        ContentValues cv= new ContentValues();
        cv.put(KEY_TITLE,title);
        cv.put(KEY_DATE,date);
